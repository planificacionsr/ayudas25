...
lyr_GoogleSatellite_0.setVisible(true);lyr_Limites_1.setVisible(false);lyr_Barrios_2.setVisible(true);lyr_Espaciosverdes_3.setVisible(true);lyr_Redvial_4.setVisible(true);lyr_Parcelarioconpropietarios_5.setVisible(false);lyr_Ayudasporlocalidad_6.setVisible(false);lyr_EmpleadosMunicipales_7.setVisible(false);lyr_Cantidaddeayudasporpersona_8.setVisible(false);lyr_Ayudasportipo_9.setVisible(false);lyr_Ayudaspormonto_10.setVisible(true);lyr_Montoporlocalidad_11.setVisible(true);lyr_Localidades_12.setVisible(false);
var layersList = [lyr_GoogleSatellite_0,lyr_Limites_1,lyr_Barrios_2,lyr_Espaciosverdes_3,lyr_Redvial_4,lyr_Parcelarioconpropietarios_5,lyr_Ayudasporlocalidad_6,lyr_EmpleadosMunicipales_7,lyr_Cantidaddeayudasporpersona_8,lyr_Ayudasportipo_9,lyr_Ayudaspormonto_10,lyr_Montoporlocalidad_11,lyr_Localidades_12];
lyr_Limites_1.set('fieldAliases', {'Name': 'Name', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'Poblaci√É¬': 'Poblaci√É¬', });
...
lyr_Limites_1.set('fieldImages', {'Name': 'TextEdit', 'tessellate': 'TextEdit', 'extrude': 'TextEdit', 'visibility': 'TextEdit', 'Poblaci√É¬': 'TextEdit', });
...
lyr_Ayudasportipo_9.set('fieldImages', {'id': 'TextEdit', 'Localidad': 'TextEdit', 'FECHA': 'TextEdit', 'DTTO': 'TextEdit', 'DNI': 'TextEdit', 'NOMCOM': 'TextEdit', 'DIRECCION': 'TextEdit', 'EDAD 2025': 'TextEdit', 'LOCALIDA_1': 'TextEdit', 'AYUDA': 'TextEdit', 'DETALLE': 'TextEdit', 'MONTO': 'TextEdit', 'EXP': 'TextEdit', 'CANT_AYU': 'TextEdit', 'EMP': 'TextEdit', 'CANT/PER': 'TextEdit', });
...
lyr_Limites_1.set('fieldLabels', {'Name': 'header label - always visible', 'tessellate': 'hidden field', 'extrude': 'hidden field', 'visibility': 'hidden field', 'Poblaci√É¬': 'hidden field', });
...
lyr_Ayudasportipo_9.set('fieldLabels', {'id': 'no label', 'Localidad': 'hidden field', 'FECHA': 'header label - always visible', 'DTTO': 'header label - always visible', 'DNI': 'header label - always visible', 'NOMCOM': 'header label - always visible', 'DIRECCION': 'header label - always visible', 'EDAD 2025': 'header label - always visible', 'LOCALIDA_1': 'header label - always visible', 'AYUDA': 'header label - always visible', 'DETALLE': 'no label', 'MONTO': 'header label - always visible', 'EXP': 'header label - always visible', 'CANT_AYU': 'header label - always visible', 'EMP': 'hidden field', 'CANT/PER': 'hidden field', });
