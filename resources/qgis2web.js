...
map.getView().fit([-7587185.986535, -3930262.634568, -7583772.641103, -3928004.055097], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ayudas económicas otorgadas Ene-Ago 2025</h2>';
        return titleElement;
    })(),
