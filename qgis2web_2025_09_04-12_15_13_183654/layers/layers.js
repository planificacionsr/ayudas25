...
var lyr_Ayudaspormonto_8 = new ol.layer.Vector({
    ...
    <img src="styles/legend/Ayudaspormonto_8_0.png" /> 12500 - 40000<br />\
    <img src="styles/legend/Ayudaspormonto_8_1.png" /> 40000 - 80000<br />\
    <img src="styles/legend/Ayudaspormonto_8_2.png" /> 80000 - 140000<br />\
    <img src="styles/legend/Ayudaspormonto_8_3.png" /> 140000 - 190000<br />\
    <img src="styles/legend/Ayudaspormonto_8_4.png" /> 190000 - 300000<br />' });
var format_Montoporlocalidad_9 = new ol.format.GeoJSON();
var features_Montoporlocalidad_9 = format_Montoporlocalidad_9.readFeatures(json_Montoporlocalidad_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Montoporlocalidad_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Montoporlocalidad_9.addFeatures(features_Montoporlocalidad_9);
var lyr_Montoporlocalidad_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Montoporlocalidad_9, 
                style: style_Montoporlocalidad_9,
                popuplayertitle: 'Monto por localidad',
                interactive: true,
    title: 'Monto por localidad<br />\
    <img src="styles/legend/Montoporlocalidad_9_0.png" /> 50000 - 200000<br />\
    <img src="styles/legend/Montoporlocalidad_9_1.png" /> 200000 - 600000<br />\
    <img src="styles/legend/Montoporlocalidad_9_2.png" /> 600000 - 1200000<br />\
    <img src="styles/legend/Montoporlocalidad_9_3.png" /> 1200000 - 3000000<br />\
    <img src="styles/legend/Montoporlocalidad_9_4.png" /> 3000000 - 7608133<br />' });
var format_Localidades_10 = new ol.format.GeoJSON();
var features_Localidades_10 = format_Localidades_10.readFeatures(json_Localidades_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Localidades_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Localidades_10.addFeatures(features_Localidades_10);
var lyr_Localidades_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Localidades_10, 
                style: style_Localidades_10,
                popuplayertitle: 'Localidades',
                interactive: true,
                title: '<img src="styles/legend/Localidades_10.png" /> Localidades'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_Limitesnuevos_Distritos_1.setVisible(false);lyr_barrios_publicos_2.setVisible(true);lyr_Espaciosverdes_3.setVisible(true);lyr_Redvial_4.setVisible(true);lyr_Parcelarioconpropietarios_5.setVisible(false);lyr_Ayudasporlocalidad_6.setVisible(false);lyr_Ayudasportipo_7.setVisible(false);lyr_Ayudaspormonto_8.setVisible(true);lyr_Montoporlocalidad_9.setVisible(true);lyr_Localidades_10.setVisible(false);
var layersList = [lyr_GoogleSatellite_0,lyr_Limitesnuevos_Distritos_1,lyr_barrios_publicos_2,lyr_Espaciosverdes_3,lyr_Redvial_4,lyr_Parcelarioconpropietarios_5,lyr_Ayudasporlocalidad_6,lyr_Ayudasportipo_7,lyr_Ayudaspormonto_8,lyr_Montoporlocalidad_9,lyr_Localidades_10];
...
lyr_Montoporlocalidad_9.set('fieldAliases', {'Name': 'Name', 'Distrito': 'Distrito', 'CANTIDAD': 'CANTIDAD', 'MONTO': 'MONTO', 'MONTO_LEG': 'MONTO_LEG', });
lyr_Localidades_10.set('fieldAliases', {'Name': 'Name', 'Distrito': 'Distrito', 'CANTIDAD': 'CANTIDAD', 'MONTO': 'MONTO', 'MONTO_LEG': 'MONTO_LEG', });
...
lyr_Ayudaspormonto_8.set('fieldImages', {'id': 'TextEdit', 'Localidad': 'TextEdit', 'FECHA': 'TextEdit', 'DTTO': 'TextEdit', 'DNI': 'TextEdit', 'NOMCOM': 'TextEdit', 'DIRECCION': 'TextEdit', 'EDAD 2025': 'TextEdit', 'LOCALIDA_1': 'TextEdit', 'AYUDA': 'TextEdit', 'DETALLE': 'TextEdit', 'MONTO': 'TextEdit', 'EXP': 'TextEdit', 'CANT_AYU': 'TextEdit', });
lyr_Montoporlocalidad_9.set('fieldImages', {'Name': 'TextEdit', 'Distrito': 'TextEdit', 'CANTIDAD': 'TextEdit', 'MONTO': 'TextEdit', 'MONTO_LEG': 'TextEdit', });
lyr_Localidades_10.set('fieldImages', {'Name': 'TextEdit', 'Distrito': 'TextEdit', 'CANTIDAD': 'TextEdit', 'MONTO': 'TextEdit', 'MONTO_LEG': 'TextEdit', });
...
lyr_Montoporlocalidad_9.set('fieldLabels', {'Name': 'no label', 'Distrito': 'header label - always visible', 'CANTIDAD': 'hidden field', 'MONTO': 'hidden field', 'MONTO_LEG': 'header label - always visible', });
lyr_Localidades_10.set('fieldLabels', {'Name': 'no label', 'Distrito': 'header label - always visible', 'CANTIDAD': 'hidden field', 'MONTO': 'hidden field', 'MONTO_LEG': 'hidden field', });
lyr_Localidades_10.on('precompose', function(evt) {
